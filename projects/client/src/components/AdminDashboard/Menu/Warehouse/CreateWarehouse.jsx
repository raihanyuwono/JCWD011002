...
const CreateWarehouse = ({ isDrawerCreateOpen, setIsDrawerCreateOpen, handleCreateWarehouse, province, selectedProvinceId, editedWarehouse, setEditedWarehouse, city, handleSelectProvince }) => {
  return (
